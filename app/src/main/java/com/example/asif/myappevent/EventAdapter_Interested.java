...
public class EventAdapter_Interested extends RecyclerView.Adapter<EventAdapter_Interested.sViewHolder> {

    private List<EventDetails> list;
    private Context context;
    private DatabaseReference mDatabase ,mDatabaseCount;
    private FirebaseAuth mAuth;
    public EventAdapter_Interested(List<EventDetails> list) {
        this.list = list;
