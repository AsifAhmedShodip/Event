...
public class CreatEventsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  mCreat.setOnClickListener(new View.OnClickListener() {
                    ...
                    builder1.setPositiveButton(
                            ...
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                   // String key = EventDetails.tEventID;
                                            ...
                                            builder2.setPositiveButton(
                                                    ...
                                                    new DialogInterface.OnClickListener() {
                                                        public void onClick(DialogInterface dialog, int id) {
                                                           ...
                                                           // EventDetails.tEventID = EventDetails.tEventID;
       ...
       /* mDescription.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CreatEventsActivity.this, EventDescriptionActivity.class);
                startActivity(intent);
            }
        });*/
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_menu_done:
                ...
                Toast.makeText(CreatEventsActivity.this,"ssssssssssssssssss",Toast.LENGTH_SHORT).show();
                break;
    ...
    {
        //Toast.makeText(context,"ssssssssssssssssss",Toast.LENGTH_SHORT).show();
        if(requestCode == request_Code && resultcode == RESULT_OK)
        {
            ...
            mLoc = (EditText) findViewById(R.id.Loc);
            mLoc.setText(name+"\n"+address);
           // Toast.makeText(CreatEventsActivity.this,"address",Toast.LENGTH_SHORT).show();
        }
    }
}
