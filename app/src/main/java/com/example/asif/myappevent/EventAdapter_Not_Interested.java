...
public class EventAdapter_Not_Interested extends RecyclerView.Adapter<EventAdapter_Not_Interested.sViewHolder> {

    private List<EventDetails> list;
    private Context context;
    private DatabaseReference mDatabase ,mDatabaseCount;
    private FirebaseAuth mAuth;
    public EventAdapter_Not_Interested(List<EventDetails> list) {
        this.list = list;
