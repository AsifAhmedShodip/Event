...
public class Invitation_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.invitation_fragment,container,false);
        ...
        adapter=new EventAdapter_Invitations(list);
        ...
        mDatabase.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
               ...
               /* try {
                ...
                if(!list_keys.contains(key) && outdated == false) {
                    list.add(temp);
                    list_keys.add(key);
                }
