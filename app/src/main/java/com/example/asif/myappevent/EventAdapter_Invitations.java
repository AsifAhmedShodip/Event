...
public class EventAdapter_Invitations extends RecyclerView.Adapter<EventAdapter_Invitations.sViewHolder> {

    private List<EventDetails> list;
    private Context context;
    private DatabaseReference mDatabase ,mDatabaseCount;
    private FirebaseAuth mAuth;
    public EventAdapter_Invitations(List<EventDetails> list) {
        this.list = list;
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot users : dataSnapshot.getChildren())
                {
                    ...
                    //  Toast.makeText(context,"Looping "+count_Attending[0],Toast.LENGTH_SHORT).show();
                }
            }
        ...
        holder.checkBox3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(holder.checkBox3.isChecked())
                {
                    ...
                    mDatabase = FirebaseDatabase.getInstance().getReference().child("Invitation_Events").child(userID);
                    mDatabase.child(temp.eventID).removeValue();
                }
                else
                {
