...
public class Not_Intersted_Fragment extends Fragment {
    private static final String TAG = "NOT INTERESTED";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.not_interested_fragment,container,false);
        ...
        adapter=new EventAdapter_Not_Interested(list);
